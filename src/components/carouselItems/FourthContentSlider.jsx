...
function FourthContentSlide(props) {
    ...
    <div className="slide-wrapper">
          ...
          {slideSettings?.type !== "imageOnly" && (
            <div className="slide__text-wrapper">
              ...
              {(slideSettings.description &&
                (slideSettings?.type === "textAndImage" ||
                  slideSettings?.type === "textOnly")) && (
                  <div className={`title description-font-${textSize}`} style={{ color: colorPalate.third, fontFamily: fontFamily2 }}>{slideSettings.descriptionValue}</div>
                )}
            </div>
          )}
          {(slideSettings?.type === "imageOnly" ||
...

      {
        props.download && <div className="slide_individual_settings">
          ...
          <div className="configure-title">{t('fourth-slide-setting')}</div>
          <div className="configure-container">
            ...
            <div className="btn-group w-100">
              ...
              />
              <label className="btn btn__radio-check" htmlFor="frtextOnly">
                {t('textOnly')}
              </label>
              <Input
                type="radio"
              ...
              />
              <label className="btn btn__radio-check" htmlFor="frtextAndImage">
                {t('textandimage')}
              </label>
              ...
              />
              <label className="btn btn__radio-check" htmlFor="frimageOnly">
                {t('imageOnly')}
              </label>
            </div>
          </div>
...
export default FourthContentSlide;
